---
layout: post
title: "Quest 1, Cycle 2: Vom Verstehen zum Handeln - Prototyping im Spannungsfeld"
...
excerpt: "Der Übergang von der Theorie zur Praxis: Wie aus Erkenntnissen über kognitives Offloading ein konkreter Prototyp entsteht - und welche Tools dabei helfen, ohne die eigene Denkfähigkeit zu untergraben."
---
...
Diese Woche wurde ich von einem Projekt absorbiert, an dem ich bereits seit einiger Zeit arbeite. Es handelt sich um eine App, die darauf spezialisiert ist Interviews mit dem Nutzer zu führen. KI ist also hier ein wichtiger Teil der Funktion an sich. KI dient hier als Interface, im weiteren Sinne.
...
In den letzten Monaten ist das Prototyping jedenfalls massiv einfacher und schneller geworden, wenn die Werkzeuge kennt und sie bedienen kann.
Kurz gesagt, was ich in der letzten Woche in ca. 5 Tagen auf Beine gestellt habe, hätte mich vor einem Jahr noch vier Wochen gekostet.
...
Was nicht so sehr bekannt ist: Einige der Tools lassen sich sehr gut auch für andere Zwecke einsetzen, die nichts mit Programmierung zu tun haben.
Zum Beispiel Schreiben, Recherchieren, Inhalte erstellen. Solange im Hintergrung große Sprachmodelle (LLMs) wie z.B. GPT-4o oder Claude-Sonnet laufen, stehen die selben Fähigkeiten zur Verfügung wie bei ChatGPT oder Claude.ai.
...
- **Perplexity** für die Erstellung von speziellen Dokumentationen zu bestimmten Libraries, die verwendetet werden (z.B. ElevenLabs für die Sprachausgabe)
...
In diesen 5 Stunden entstand die qualitative Grundlage für die App, auf der die KI (Cline und Claude) dann erfolgreich aufbauen konnten.
...
Es war einigermaßen mühselig und nicht gerade spaßig, jede einzelne der ca. 40 unterschiedlichen Funktionen zu durchdenken, und dies schriftlich zu formulieren. Aber es hat sich gelohnt, keine Fragen offen zu lassen und für die maximale Klarheit zu sorgen.

Ein Prinzip was nicht nur für die Programmierung hilfreich ist, und nicht nur für die Zusammenarbeit mit KI.
